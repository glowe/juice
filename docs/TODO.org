...
* NEXT Implement some juice.namespace helpers
...
* IMPORTANT Convert all form inputs to work regardless of state
* IMPORTANT Form inputs template param should be called render
